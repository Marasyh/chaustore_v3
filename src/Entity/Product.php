 ...
 * Product
 *
 * @ORM\Table(name="product", indexes={@ORM\Index(name="product_brand", columns={"brand_id"}), @ORM\Index(name="product_category", columns={"category_id"}), @ORM\Index(name="name", columns={"name"}), @ORM\Index(name="product_color", columns={"color_id"})})
 * @ORM\Entity
 */
class Product
{
